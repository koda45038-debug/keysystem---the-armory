...
local Config = {
    ...
    ServiceId       = 26530, -- Your PlatoBoost Service ID
    PlatoSecret     = "312adbcd-e325-4aa5-af2a-bea137225634", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/koda45038-debug/keysystem---the-armory/refs/heads/main/syrift.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Syript.lua - the armory", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Syript.lua - the armory, -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Syript.lua - the armory", -- The main title shown at the top of the GUI
    HubDescription  = "discord" -- The text shown below the title
}
